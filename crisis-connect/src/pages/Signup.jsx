        ...
        <div className='w-full pt-20 h-screen grid grid-cols-2'>
            ...
            <div className='w-full h-full bg-white grid place-items-center'>
                <form action="">
                    ...
                    <Link to={"/"} type="button" class="text-center flex itesmc-enter justify-center mt-5 w-full py-3 px-4  items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-950 text-white hover:bg-blue-900 focus:outline-none focus:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                        Signup
                    </Link>
                </form>
            </div>
